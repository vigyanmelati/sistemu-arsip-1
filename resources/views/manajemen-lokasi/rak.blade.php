        ...
        @forelse($raks as $index => $rak)
            ...
            <div class="col-sm-6 col-lg-4 col-xl-3 rak-card" data-rak="{{ strtolower($rakName) }}">
                <div class="card h-100 border-0 shadow-sm hover-card rounded-4 overflow-hidden position-relative">
                    ...
                    <a href="{{ route('manajemen-lokasi.box', [$ruangan, $rakName]) }}" class="text-decoration-none d-block h-100">
...
<div class="modal fade" id="modalTambahRak" tabindex="-1" aria-labelledby="modalTambahRakLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form action="{{ route('manajemen-lokasi.store-rak') }}" method="POST">
                @csrf
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="nomor_rak" class="form-label" style="font-weight:bold">Nomor Rak</label>
        ...
        <div class="modal-content">
            <form id="formEditRak" action="" method="POST">
                ...
                <div class="modal-body">
                    <input type="hidden" name="lokasi_arsip" value="{{ $ruangan }}">
                    <div class="mb-3">
                        <label for="edit_nomor_rak" class="form-label" style="font-weight:bold">Nomor Rak</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <form id="formHapusRak" action="" method="POST">
                ...
                @method('DELETE')
                <div class="modal-header">
                    <h5 class="modal-title text-danger" id="modalHapusRakLabel">Konfirmasi Hapus Rak</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus rak <strong id="hapusRakNama"></strong>?</p>
                    <p class="text-danger"><i class="bi bi-exclamation-triangle-fill me-1"></i> Rak yang memiliki box tidak dapat dihapus. Pindahkan atau hapus box terlebih dahulu.</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Modal Edit - isi data
        var editModal = document.getElementById('modalEditRak');
